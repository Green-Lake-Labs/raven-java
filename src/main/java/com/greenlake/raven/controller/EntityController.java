...
import com.greenlake.raven.model.price.PriceData;
...
import com.greenlake.raven.model.symbol.TickerSymbol;
...
public class EntityController {
    ...
    @GetMapping(value = "/getCashFlowData/{symbol}",
            produces = MediaType.APPLICATION_JSON_VALUE)
    public List<CashFlowData> fetchCashFlowData(@PathVariable String symbol) {
